		...
		try {
			...
			mWebSocket.setEventHandler(new WebSocketEventHandler() {
				...
				public void onMessage(WebSocketMessage message) {
					...
					try {
						Log.d("Pusher","parsing json");
						Log.d("Pusher",message.getText());
						...
						String eventData = parsed.getString("data").replace('"', ' ').trim();
						
						Log.d("Pusher",eventData);
						...
						Log.d("Pusher","Failed to parse json");
						e.printStackTrace();
					}
				}
